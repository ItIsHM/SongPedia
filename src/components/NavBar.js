                                ...
                                <div className="text-base">
                                    <div className="relative inline-block w-10 mr-2 align-middle select-none">
                                        <input
                                            ...
                                            id="dark_mode"
                                            className="checked:bg-green-700 outline-none focus:outline-none right-4 checked:right-0 duration-200 ease-in absolute block w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer"
                                        />
                                        <label
                                            htmlFor="dark_mode"
                                            className="block h-6 overflow-hidden bg-green-500 rounded-full cursor-pointer"
                                        ></label>
                                    </div>
