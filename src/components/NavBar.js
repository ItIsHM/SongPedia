            ...
            <header>
                <nav className="flex flex-wrap items-center justify-between w-full py-2 md:py-3 px-4 text-lg fixed top-0 z-50 dark:text-gray-700 text-gray-400 dark:bg-light-200 bg-deep-900 body-font">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" id="menu-button" onClick={() => document.getElementById("menu").classList.toggle('hidden')} className="h-6 w-6 cursor-pointer md:hidden block"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke="white">
                    ...
                    <div className="hidden w-full md:flex md:items-center md:w-auto" id="menu">
                        <ul className="pt-4 space-y-3 md:space-y-0 text-base md:flex md:justify-between md:pt-0">
                            ...
                            <li>
                                <Link to="/" className="mr-5 hover:text-white hover:dark:text-white cursor-pointer" onClick={() => document.getElementById("menu").classList.toggle('hidden')}>Home
                                </Link>
                            </li>
                            <hr className='dark:border-gray-700 border-light-200' />
                            <li>
                                <Link to="/search" className="mr-5 hover:text-white hover:dark:text-white cursor-pointer" onClick={() => document.getElementById("menu").classList.toggle('hidden')}>Search
                                </Link>
                            </li>
                            <hr className='dark:border-gray-700 border-light-200' />
                            <li>
                                <Link to='/about' className="mr-5 hover:text-white hover:dark:text-white cursor-pointer" onClick={() => document.getElementById("menu").classList.toggle('hidden')} >About</Link>
                            </li>
                            <hr className='dark:border-gray-700 border-light-200' />
                            <li>
                                <Link to='/terms' className="mr-5 hover:text-white hover:dark:text-white cursor-pointer" onClick={() => document.getElementById("menu").classList.toggle('hidden')}>Terms of Use</Link>
                            </li>
                            <hr className='dark:border-gray-700 border-light-200' />
                            <li>
